 ...
 * Comparison emoji are exactly as the appendix lists them — rows the appendix
 * gives no emoji for store an empty string, so the UI must render the emoji
 * conditionally.
 *
...
export const SIZE_TABLE = {
  ...
  8: { lengthMm: 16, basis: CR, weightG: 1, comparison: { name: 'raspberry', emoji: '' } },
  ...
  11: { lengthMm: 41, basis: CR, weightG: 7, comparison: { name: 'fig', emoji: '' } },
  ...
  25: { lengthMm: 346, basis: CH, weightG: 660, comparison: { name: 'cauliflower', emoji: '' } },
  26: { lengthMm: 356, basis: CH, weightG: 760, comparison: { name: 'head of lettuce', emoji: '🥬' } },
  27: { lengthMm: 366, basis: CH, weightG: 875, comparison: { name: 'rutabaga', emoji: '' } },
  28: { lengthMm: 376, basis: CH, weightG: 1005, comparison: { name: 'eggplant', emoji: '🍆' } },
  29: { lengthMm: 386, basis: CH, weightG: 1150, comparison: { name: 'butternut squash', emoji: '' } },
